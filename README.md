# How to customize the Segmented Item with Custom Font in the .NET MAUI SegmentedControl

This repository contains the sample code to customize the segmented item with custom font in the [SfSegmentedControl](https://help.syncfusion.com/maui/segmented-control/getting-started).
